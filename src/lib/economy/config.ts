...
export const CRAFT_CONFIG = {
  ...
  skin_street_runner: { type: 'skin', tier: 'common', name: 'Street Runner', sprite: '/game/chars/street_runner.png' },
  skin_1: { type: 'skin', tier: 'rare', name: 'Neon Runner', sprite: '/game/chars/skin1.png' },
  skin_2: { type: 'skin', tier: 'rare', name: 'Pixel Dude', sprite: '/game/chars/skin2.png' },
  skin_default: { type: 'skin', tier: 'rare', name: 'Builder', sprite: '/game/player.png' },
  skin_3: { type: 'skin', tier: 'rare', name: 'Shadow', sprite: '/game/chars/skin3.png' },
  skin_4: { type: 'skin', tier: 'rare', name: 'Gold Rush', sprite: '/game/chars/skin4.png' },
  skin_5: { type: 'skin', tier: 'epic', name: 'Cyber Punk', sprite: '/game/chars/skin5.png' },
  skin_6: { type: 'skin', tier: 'epic', name: 'Ocean Rider', sprite: '/game/chars/skin6.png' },
  skin_7: { type: 'skin', tier: 'epic', name: 'Flame Chaser', sprite: '/game/chars/skin7.png' },
  skin_founder: { type: 'skin', tier: 'epic', name: 'Founder', sprite: '/game/chars/founder.png' },
  skin_8: { type: 'skin', tier: 'legendary', name: 'Arctic', sprite: '/game/chars/skin8.png' },
  skin_9: { type: 'skin', tier: 'legendary', name: 'Desert Storm', sprite: '/game/chars/skin9.png' },
  skin_10: { type: 'skin', tier: 'legendary', name: 'Thunder', sprite: '/game/chars/skin10.png' },
  skin_11: { type: 'skin', tier: 'legendary', name: 'Diamond Hands', sprite: '/game/chars/skin11.png' },
